    ...
    return (
        <div className={className} {...props} ref={ref}>
            <Card className={styles.product}>
                ...
                <div className={styles.tags}>{product.categories.map(c => <Tag className={styles.categoty} key={c} color="ghost" size="m">{c}</Tag>)}</div>
            ...
            <motion.div layout animate={isReviewOpened ? variants.visible : variants.hidden} variants={variants} initial='hidden'>
